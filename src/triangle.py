...
class Triangle:
    def __init__(self):
        self.v1: Vector = Vector()
        self.v2: Vector = Vector()
        self.v3: Vector = Vector()
    ...
    def contains(self, v: Vector) -> bool:
        ...
        (v2_prime_conj, v3_prime_conj) = make_conjugate(v2_prime, v3_prime)
        c2 = dot(v_prime, v2_prime_conj)
        c3 = dot(v_prime, v3_prime_conj)
